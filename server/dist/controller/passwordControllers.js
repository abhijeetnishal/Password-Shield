...
const getAllPasswords = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // db.connect;
        //get data from DB
        const { rows } = yield dbConnect_1.default.pool.query(`SELECT * FROM passwords WHERE createdBy = $1`, [userId]);
...
const decryptPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { rows } = yield dbConnect_1.default.pool.query(`SELECT * FROM passwords WHERE _id = $1`, [passwordId]);
        if (rows.length === 0)
    ...
    try {
        ...
        if (websiteName === "" || password === "") {
            ...
            if (rows.length === 0) {
                ...
                yield dbConnect_1.default.pool.query(`UPDATE passwords SET websitename = $1, password = $2, iv = $3 WHERE _id = $4`, [websiteName, encryptedPassword, base64data, passwordId]);
