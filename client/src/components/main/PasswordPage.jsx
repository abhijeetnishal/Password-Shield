  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await fetch(
        `${process.env.REACT_APP_HOST_URL}/passwords/all/${userId}`,
        {
          method: "GET",
          headers: {
  ...
  return (
    <div className="main-container" style={{ height: `${containerHeight}px` }}>
      <div className="headingContainer">
        <div className="yourSavedPasswordText">Your Saved Passwords</div>
            ...
            <div className="singlePasswordContainer" key={index}>
              <div className="commonImgNamePasswordDecypt">
                ...
                <div className="namePasswordDecryptContainer">
                  ...
                  >
                    {isPasswordEyeBtnClicked ? (
                      <img src={cutEye} alt="" className="decryptBtnImg" />
                    ) : (
