        ...
        <div className={`relative ${theme === 'light' ? 'bg-white text-gray-900' : 'bg-[#1c1c1c] text-white'} rounded-lg m text-left shadow-xl transform transition-all sm:my-8`}>
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => onSubmit({ websiteName, password })} className={`px-3 mt-4 py-2  ${theme === 'dark' ? 'bg-[#292929] text-[#73d285]' : 'bg-[#F8F8FF] text-[#73d285]'} border border-gray-500 rounded-lg hover:text-white  hover:bg-[#73d285]`}
