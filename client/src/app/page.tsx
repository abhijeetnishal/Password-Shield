  ...
  return (
    <>
      ...
      <div data-testid="landing-page" className=' h mx-auto'>
        <section>
          <div className={`flex md:p-24 p-6 section1 pb-44 ${theme === 'light' ? 'bg-[#fffcd7]  text-black' : 'bg-[#12141d] text-white'}`}>

            <Image src={theme ==='light'? illustration1 : illustration1Dark} className='hidden md:block w-[35rem] px-5' alt="" />
            <div className='px-5'>
        ...
        <section id='about'>
          <div className=' '></div>
          <div className=' md:flex  md:px-24 py-16 justify-between'>
        ...
        <section>
          <div className={`flex py-10  md:px-24 section3  ${theme === 'light' ? 'bg-[#fffcd7]  text-black' : 'bg-[#12141d] text-white'}`}>

            <div className='md:px-5 px-11 py-6 md:py-36 flex-col flex align-middle'>
              ...
              <div>
                <h2 className='md:mr-72  pt-7 text-[#595a61] text-base'>With Key Safe, you can trust that your credentials are only accessible to you, providing peace of mind in an increasingly digital world.</h2>
              </div>
            </div>
        ...
        <section>
          <div className='flex py-10  md:px-24  bg-[#fafafa]'>

            <Image src={illustration3} className='hidden md:block w-[35rem] px-5' alt="" />
            <div className='px-11 md:py-36 flex-col flex align-middle'>
              <div className='md:ml-56 '>
                <h2 className={`md:text-5xl text-2xl ${spaceGrotesk.className} font-bold`}>All password within a reach</h2>
              </div>
              <div>
                <h2 className='md:ml-56 md:mr-20 text-left pt-7 text-[#595a61] text-base'>Save all your password at one place within minutes. And you don't have to crack your head to remember them.</h2>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id='contact'>
          <div className='text-center p-16 py-20 section4 bg-[#18181b]'>
            ...
            <p className='text-white text-center py-5 md:px-80'>Key Safe thrives on community support and contributions. Whether you're a developer, a security enthusiast, or simply someone who values secure password management, we welcome you to join us. Contribute to the project, report issues, or share your feedback.</p>
        ...
        <section>
          <div className='md:flex md:py-20  px-11 md:px-24  bg-[#fafafa]'>
            ...
            <div className='md:flex py-10 w-[95rem] justify-center'>
