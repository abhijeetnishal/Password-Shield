      ...
      <div data-testid="landing-page" className=' h mx-auto'>
        ...
        <section>
          <div className='flex py-4  md:px-24 items-center bg-[#fafafa]'>
            ...
            <div className='px-11 md:py-36 flex-col flex align-middle'>
              ...
              <div className='xl:ml-52' >
                <h2 className=' md:mr-20 text-left pt-7 text-[#595a61] text-base'>Save all your password at one place within minutes. And you don't have to crack your head to remember them.</h2>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id='contact'>
          <div className='text-center p-16 py-20 section4 bg-[#18181b]'>
            ...
            <p className='text-white text-center py-5 px-20 xl:px-80'>Key Safe thrives on community support and contributions. Whether you're a developer, a security enthusiast, or simply someone who values secure password management, we welcome you to join us. Contribute to the project, report issues, or share your feedback.</p>
        ...
        <section>
          <div className='flex md:py-20 items-center px- xl:px-24  bg-[#fafafa]'>


            <div className='px-5 flex-col py-10 justify-center flex align-middle'>
              <div className=''>
                <h2 className={`text-3xl  ${spaceGrotesk.className} font-bold`}>Ready to get started?</h2>
              </div>
              <div>
                <h2 className='text-left xl:mr-40 pt-5 pb-3 text-[#595a61] text-base'>Dive into a world where password management is no longer a headache. Our platform welcomes you to streamline your digital security effortlessly.</h2>
            ...
            <div className='md:flex py-10  justify-center'>
              <div className='xl:mx-10 px-5 my-2 w-72 border-2 rounded py-5 bg-white'>
                {/* <Image src={icon5} alt='' /> */}
                <div>
                  <Icon5></Icon5>
                </div>
              ...
              <div className='xl:mx-10 px-5 w-72 my-2 border-2 rounded py-5 bg-white'>
                {/* <Image src={icon4} alt='' /> */}
                <div>
                  <Icon4></Icon4>
                </div>
