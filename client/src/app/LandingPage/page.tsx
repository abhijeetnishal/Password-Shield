...
export default function LandingPages() {
  ...
  return (
    <>
      {/* <Header/> */}
      <Navbar />
      <div data-testid="landing-page" className='bg-[#fafafa] h mx-auto'>
        <section>
          <div className={`flex p-24 section1 pb-44 ${theme === 'light' ? 'bg-[#fafafa] text-black' : 'bg-[#12141d] text-white'}`}>
        ...
        <section>
          <div className={`flex py-10  px-24 section3  ${theme === 'light' ? 'bg-[#fafafa] text-black' : 'bg-[#12141d] text-white'}`}>
