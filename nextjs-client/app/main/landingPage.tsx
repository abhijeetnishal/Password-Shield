...
const LandingPage = () => {
  ...
  return (
    <div data-testid="landing-page" className=''>
      <section data-testid="hero-section" className=' bg-amber-50 flex flex-col items-center justify-center py-24'>
        ...
        <Link data-testid="get-started-link" href='/register'  className='bg-cyan-500 rounded text-white flex flex-row py-2 px-4'>
          <div className=''> Get Started </div>
          <Image className='' width={24} height={24} src={rightArrow} alt="" />
        </Link>
        </div>
      </section>
      <div data-testid="more-info-section" className='flex flex-col md:flex-row'>
          <section className='py-12 flex flex-col items-center md:w-1/2'>
            <Image className='m-4' src={subMoreInfoImg1} alt="" />
            <h2 className='font-semibold text-xl'>All password within a reach</h2>
            <p className='text-center w-2/3 '>All your password within a reach so you don't have to crack your head to remember them.</p>
          </section>
          <section className='py-12 flex flex-col items-center md:w-1/2'>
            <Image className='m-4' src={subMoreInfoImg2} alt="" />
            <h2 className='font-semibold text-xl'>Easy & Convenient</h2>
            <p className='text-center w-2/3 '>Save all your password at one place within minutes.</p>
          </section>
      </div> 
    </div>
  )
