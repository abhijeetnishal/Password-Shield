...
const DeleteConfirmation = (props: DeleteConfProps) => {
  ...
  return (
    <div data-testid="delete-confirmation" onClick={onClose} className='shadow fixed right-[5%] left-[5%] lg:right-1/4 lg:left-1/4 flex flex-row items-start justify-center bg-white'>
      <div onClick={(e) => {e.stopPropagation();}} className='shadow-md border rounded flex flex-col w-full p-4 h-60 justify-evenly'>
            ...
            <div className="flex flex-row items-center justify-evenly">
              ...
              <button className='flex flex-row items-center justify-center border border-teal-600  bg-teal-600 m-1 rounded p-1 text-white w-full' onClick={handleConfirmationDelete}>
