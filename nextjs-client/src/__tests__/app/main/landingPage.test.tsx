...
describe("<LandingPage />", () => {
  ...
  it("Hero section text is in the document", () => {
    ...
    expect(heroSection.textContent).toMatch(
  ...
  it("More info section text is in the document", () => {
    ...
    expect(moreInfo.textContent).toMatch(
      "All your password within a reach so you don't have to crack your head to remember them."
    );
